...
void test_plppf_1d() noexcept {
  ...
  auto element_map = ElementMap<1, Frame::Inertial>(
      ...
      domain::make_coordinate_map_base<Frame::Logical, Frame::Inertial>(
          Affine(-1., 1., 3., 7.)));
  auto element_map_hacky = ElementMap<1, Frame::Grid>(
  ...
  ppflux_triggered = plppf(
      make_not_null(&mass_density), make_not_null(&momentum_density),
      make_not_null(&energy_density), mesh, logical_coords, element_map_hacky,
...
void test_plppf_2d() noexcept {
  ...
  auto element_map_hacky = ElementMap<2, Frame::Grid>(
      self_id, domain::make_coordinate_map_base<Frame::Logical, Frame::Grid>(
                   Affine2D(xi_map, eta_map)));
