...
/// (HWENO) limiter of \cite Zhu2016. See the documentation of the system-
/// agnostic ::Limiters::Weno limiter for a general discussion of the algorithm
/// and the various options that control the action of the limiter.
//
